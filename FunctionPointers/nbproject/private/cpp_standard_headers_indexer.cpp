...
#include <std::istream>          // std::basic_std::istream class template and several typedefs
#include <std::ostream>          // std::basic_std::ostream, std::basic_istd::ostream class templates and several typedefs
#include <istd::ostream>         // several standard stream objects
#include <fstream>          // std::basic_fstream, std::basic_std::ifstream, std::basic_std::ofstream class templates and several typedefs
